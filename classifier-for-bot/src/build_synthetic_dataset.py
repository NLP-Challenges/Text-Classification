...
def get_paths():
    ...
    """
    synthetic = list(Path("./classifier-for-bot/data/").glob(pattern="synthetic_*.txt"))
    human_feedback = list(Path("./classifier-for-bot/data/").glob(pattern="hf_*.txt"))
...
train.to_parquet("./classifier-for-bot/data/train_synthetic.parquet")
test.to_parquet("./classifier-for-bot/data/test_synthetic.parquet")
