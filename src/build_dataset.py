...
def sampler(dfs:list, train_split:float=0.8, seed=None):
...
if __name__ == "__main__":
    ...
    #sample datasets
    (sampled_questions_train, sampled_questions_test), (sampled_offense_train, sampled_offense_test), (sampled_concern_train, sampled_concern_test) = sampler(dfs=[questions, offensive, concern], min_max_bins=(MIN_WORD_COUNT, MAX_WORD_COUNT, BINS), train_split=TRAIN_SIZE, seed=SEED)
